 ...
 *
 */
public class MAUSAnnotatorServiceDescriptor implements AutoAnnotationServiceDescriptor{
     ...
     * 
     */
    public MAUSAnnotatorServiceDescriptor() {
        super();
        depends= new ArrayList<PredefinedLevelDefinition>(1);
        depends.add(PredefinedLevelDefinition.KAN);
...
//        provides.add(PredefinedLevelDefinition.KAN);
    ...
    public String getServiceImplementationClassname() {
        return "ips.annot.autoannotator.impl.ws.bas.maus.MAUSServiceClient";
    }
    ...
    public LocalizableMessage getTitle() {
        return new LocalizableMessage("MAUS Web service auto annotator");
    }
    ...
    public LocalizableMessage getDescription() {
        return new LocalizableMessage("Uses BAS MAUS Web service to segment audio file.");
    }
