...
public abstract class OpenAction extends AbstractAction{
	...
	public final static String NAME = new String("Open");
    public final static String ACTION_COMMAND = new String("open");
    public final static String SHORT_DESCRIPTION_VAL=new String("Open");
