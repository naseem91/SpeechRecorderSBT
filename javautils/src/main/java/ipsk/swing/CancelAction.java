...
public abstract class CancelAction extends AbstractAction{
	...
	public final static String NAME = new String("Cancel");
    public final static String ACTION_COMMAND = new String("cancel");
    public final static String SHORT_DESCRIPTION_VAL=new String("Cancel");
