...
public abstract class ApplyAction extends AbstractAction{

	public final static String NAME = new String("Apply");
    public final static String ACTION_COMMAND = new String("apply");
    public final static String SHORT_DESCRIPTION_VAL=new String("Apply");
