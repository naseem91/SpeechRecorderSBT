...
public abstract class OkAction extends AbstractAction{
	...
	public final static String NAME = new String("OK");
    public final static String ACTION_COMMAND = new String("ok");
    public final static String SHORT_DESCRIPTION_VAL=new String("OK");
