...
public abstract class CopyAction extends AbstractLocalizableAction{
	...
	public final static String NAME = new String("Copy");
    public final static String ACTION_COMMAND = new String("copy");
    public final static String SHORT_DESCRIPTION_VAL=new String("Copy");
