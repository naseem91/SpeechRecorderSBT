...
public abstract class ExitAction extends AbstractAction{

	public final static String NAME = new String("Exit");
    public final static String ACTION_COMMAND = new String("exit");
    public final static String SHORT_DESCRIPTION_VAL=new String("Exit");
