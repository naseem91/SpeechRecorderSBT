...
public class SetFramePositionAction extends BasicAction {
	...
	public final static String ACTION_COMMAND = new String("Set frame position");
	...
	public SetFramePositionAction() {
		...
		putValue(Action.NAME, "frame position");
		putValue(Action.SHORT_DESCRIPTION, ACTION_COMMAND);
	}
