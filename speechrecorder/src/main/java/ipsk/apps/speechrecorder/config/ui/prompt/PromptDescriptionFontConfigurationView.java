...
/**
 * UI panel for prompt description font configuration.
 * @author K.Jaensch, klausj@phonetik.uni-muenchen.de
 *
 */
public class PromptDescriptionFontConfigurationView extends JConfigPanel{
	...
	public PromptDescriptionFontConfigurationView() {
		super();
    ...
    public void setPromptConfiguration(PromptConfiguration promptConfiguration) {
       fv.setSelectedFont(promptConfiguration.getDescriptionFont());
       initialConfig=promptConfiguration;
    }

	public void applyValues(PromptConfiguration p){
	    fv.applySelectedFont(p.getDescriptionFont());
    ...
    public void resetToDefaults() {
        ...
        fv.setSelectedFont(defPc.getDescriptionFont());
    }
    ...
    public void resetToInitial() {
        if(initialConfig!=null){
            fv.setSelectedFont(initialConfig.getDescriptionFont());
        }
    }
