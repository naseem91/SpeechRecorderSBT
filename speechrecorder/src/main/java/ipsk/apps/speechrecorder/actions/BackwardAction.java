...
public class BackwardAction extends BasicAction {

	private static final long serialVersionUID = 1L;
	public final static String ACTION_COMMAND = new String("backward");
    // please do not modify ACTION_COMMAND: it is used in project config file
    public final static String SHORT_DESCRIPTION_VAL=new String("Back");
     ...
     */
    public BackwardAction(SpeechRecorder speechrecorder,String name) {
