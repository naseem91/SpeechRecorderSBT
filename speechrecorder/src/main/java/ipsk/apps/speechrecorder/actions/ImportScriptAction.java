...
public class ImportScriptAction extends BasicAction {
	
	private static final long serialVersionUID = 1L;
	public final static String ACTION_COMMAND = new String("import_script");
	
	
	public ImportScriptAction(SpeechRecorder speechRecorder, String name) {
	...
	public void actionPerformed(ActionEvent arg0) {
		if(isEnabled()){
		  speechRecorder.getSpeechRecorderUI().doImportScript();
