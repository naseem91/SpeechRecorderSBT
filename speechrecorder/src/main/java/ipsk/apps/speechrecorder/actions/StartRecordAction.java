...
public class StartRecordAction extends BasicAction {
	...
	public final static String ACTION_COMMAND = new String("start_recording");
    // please do not modify ACTION_COMMAND: it is used in project config file
	
    public final static String SHORT_DESCRIPTION_VAL=new String("Start recording");
   
	/**
	 *  
	 */
	public StartRecordAction(SpeechRecorder speechrecorder,String name) {
    ...
    public void actionPerformed(ActionEvent arg0) {
        if(isEnabled()){
           // speechRecorder.startPreRecWaiting();
