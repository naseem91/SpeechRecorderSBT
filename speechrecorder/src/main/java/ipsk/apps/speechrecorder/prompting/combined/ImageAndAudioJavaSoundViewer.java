...
/**
 * Image and audio presenter using JavaSound audio.
 *
...
@Title("Image and audio prompter")
@Description("Presents image and audio at the same time.")
...
public class ImageAndAudioJavaSoundViewer extends PromptBufferedImageViewer implements MediaPromptPresenter2{
	...
	public static final PromptPresenterServiceDescriptor DESCRIPTOR=new BasicPromptPresenterServiceDescriptor(ImageAndAudioJavaSoundViewer.class.getName(),new LocalizableMessage("Image and audio prompter"), "Institute of Phonetics and Speech processing, Munich", new ipsk.text.Version(new int[]{0,0,1}), new LocalizableMessage("Presents image and audio at the same time."),ImageAndAudioJavaSoundViewer.getSupportedMIMETypes());
...
public ImageAndAudioJavaSoundViewer() {
        super();
