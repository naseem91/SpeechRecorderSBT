...
public class RecWindowWindow extends JWindow implements RecWindow{
	...
	public RecWindowWindow(RecTransporterActions transporterActions,List<PromptPresenterServiceDescriptor> promptPresentersClassList,GraphicsConfiguration spkc,Prompter prompter) throws PluginLoadingException {
		super(spkc);
...
//		pack();
    ...
    /* (non-Javadoc)
	 * @see ipsk.apps.speechrecorder.RecWindow#attachToRecStatus()
	 */
	@Override
